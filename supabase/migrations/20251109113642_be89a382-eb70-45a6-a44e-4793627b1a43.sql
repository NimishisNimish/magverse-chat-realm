-- Update yearly pro to 500 messages per day (from 50)
DROP FUNCTION IF EXISTS public.check_and_deduct_yearly_credit(uuid);
...
BEGIN
  ...
  -- Check if user has credits remaining (500 per day for yearly pro - increased from 50)
  IF v_monthly_credits_used >= 500 THEN
